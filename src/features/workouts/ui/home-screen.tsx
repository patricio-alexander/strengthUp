...
const useWorkoutToTrain = (day: string, routineId: number | undefined) => {
  ...
  return { block, exist, isLoadingWorkout };
};
...
export default function HomeScreen() {
    ...
    Alert.alert(
      ...
      [
        ...
        },
        {
          text: "Confirmar",
          onPress: async () => {
            const success = await removeWorkout(routineId as string);
            if (success) {
  ...
  return (
    <ThemedView>
      ...
      >
        <Skeleton isLoading={isLoadingWorkout || isLoading}>
          {!workout ? (
            <Link
            ...
            <Link
              href={{
                ...
                params: {
                  routine: [workout.name, String(workout.id)],
                },
              }}
              asChild
            >
                ...
                value={() => (
                  <View>
                    ...
                    <ThemedText style={{ color: tertiary }}>
                      {useDaysInRoutine(workout.totalSessions)}
                    </ThemedText>
                  </View>
                )}
                right={() => (
                  <IconButton
                    ...
                    size={20}
                    onPress={() => {
                      setRoutineId(String(workout.id));
